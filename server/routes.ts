  ...
  app.post("/api/webhooks/payment", async (req, res) => {
    try {
      ...
      if (eventType === "payment.succeeded") {
        ...
        // Commission: 50% = $2.50 = 250 cents (ALWAYS)
        // 
        ...
        const COMMISSION_CENTS = 250;           // Fixed: $2.50 (50% of $5.00)
        ...
        if (incomingPaymentAmount !== SUBSCRIPTION_PRICE_CENTS) {
          ...
          console.warn(`[Webhook] ENFORCING fixed price - commission will be $2.50 regardless of incoming amount`);
        }
